...
def extract_options(options):
    ...
    parser.add_option('--output-path', action="store", dest="output_path", default="/home/julianarhee/Documents/video_data", help="out path directory [default: /home/julianarhee/Documents/video_data]")
